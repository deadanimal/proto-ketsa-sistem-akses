...
@Component({
  selector: "app-kelulusan-permit",
  templateUrl: "./kelulusan-permit.component.html",
  styleUrls: ["./kelulusan-permit.component.scss"],
})
export class KelulusanPermitComponent implements OnInit, OnDestroy {
  // Image
  imgLogo = "assets/img/logo/jata-negara.png";
  imgLogo1 = "assets/img/logo/qr-code.png";
  ...
  getCharts() {
    this.zone.runOutsideAngular(() => {
      this.getChartApproveApplication1();
      this.getChartApproveApplication2();
    });
  }

  getChartApproveApplication1() {
